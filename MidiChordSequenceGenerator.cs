...
public class MidiChordSequenceGenerator
{
    ...
    public void GenerateMidiFile(string fileName, int rootNote, ChordGenerator.ScaleType scaleType, int numChords, bool generateArpeggios)
    {
    ...
    public void GenerateMidiFile(string fileName, int rootNote, ChordGenerator.ScaleType scaleType, int numChords, bool generateArpeggios, bool includeBothChordAndArpeggio)
    {
        var midiEvents = new MidiEventCollection(1, ticksPerQuarterNote);
        var track = new List<MidiEvent>();
